  ...
  return `
            ...
            <div class="moda__info-card">
                ...
                <ul class="modal__sizes-list">
                    <li class="modal__list-item"><button class="modal__item-btn"><span class="modal__list-item-element">S</span>${s.size}</button></li>
                    <li class="modal__list-item"><button class="modal__item-btn"><span class="modal__list-item-element">M</span>${m.size}</button></li>
                    <li class="modal__list-item"><button class="modal__item-btn"><span class="modal__list-item-element">L</span>${l.size}</button></li>
                </ul>
                <p class="modal__additives-title">Additives</p>
                <ul class="modal__additives-list">
                    <li class="modal__list-item"><button class="modal__item-btn"><span class="modal__list-item-element">1</span>${additive1.name}</button></li>
                    <li class="modal__list-item"><button class="modal__item-btn"><span class="modal__list-item-element">2</span>${additive2.name}</button></li>
                    <li class="modal__list-item"><button class="modal__item-btn"><span class="modal__list-item-element">3</span>${additive3.name}</button></li>
                </ul>
